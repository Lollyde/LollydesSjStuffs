 ...
 * permissions:
 * [Y] sprites by mint
 * [Y] music layer modification by bloom
 * [Y] concept by worldwaker2
 */


namespace Celeste.Mod.LollydesSJContributions.Entities
{
    // I dont actually need this. this entity isnt placeable
    //[CustomEntity("sj_lollyde/PocketUmbrella")]
    class PocketUmbrella : Actor
    {
        ...
        private bool musicParamEnabled;
        ...
        public PocketUmbrella(Vector2 position, float cost, string musicParam = "") : base(position)
        {
            ...
            this.musicParamEnabled = musicParam != "none";

            Add(sprite = MainPlogon.SpriteBank.Create("pocketUmbrella"));
            sprite.Visible = false;
            Collider = new Hitbox(8, 10, -4, -10);

            Add(sweat = MainPlogon.SpriteBank.Create("pocketUmbrellaSweat"));
            sweat.Visible = false;
            sweat.CenterOrigin();
            sweat.Play("sweat");
